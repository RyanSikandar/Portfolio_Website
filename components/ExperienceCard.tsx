...
const ExperienceCard = (props: Props) => {
    return (
        ...
        md:w-[600px] xl:w-[900px] snap-center p-10 bg-[#292929] opacity-40 hover:opacity-100 cursor-pointer transition-opacity duration-200 overflow-hidden'>
            <motion.img
                initial={{
                    y: -100,
                    opacity: 0
            ...
            <div className='px-0 md:px-10'>
                ...
                <ul className='list-disc space-y-4 ml-5 text-lg'>
                    <li key="1">Developed a web portal for InLights, company focused on automating traffic signals in Islamabad.</li>
                    <li key="2">Responsible for translating Figma design to code with the use of React and Tailwind ensuring seamless integration with UI elements.</li>
                    <li key="3">Created custom components to enhance functionality and user experience.</li>
