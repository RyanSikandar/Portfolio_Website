...
function Skill({ directionLeft }: Props) {
    return (
        <div className='relative group flex cursor-pointer'>
            ...
            />
            <div className='absolute opacity-0 group-hover:opacity-80 transition duration-300 ease-in-out group-hover:bg-white h-24 w-24 xl:h-32 xl:w-32 md:w-28 md:h-28 rounded-full z-0'>
